  ...
  return (
    <>
      ...
      <Section id="qc" band="band-1" eyebrow={dict.home.manufacturing.eyebrow} title={dict.home.manufacturing.title}>
        ...
        {inspectionVideo.released && <InspectionVideo src={inspectionVideo.src} poster={inspectionVideo.poster} label={dict.media.greatHero} caption={dict.media.greatHead} />}
