...
export default function Logo({ height = 40, priority = false }) {
  ...
  return <Image src={lockup} alt="MAXIMUS GPS — Your Navigation in the World of Tennis" width={width} height={height} priority={priority} loading={priority ? undefined : "eager"} />;
}
